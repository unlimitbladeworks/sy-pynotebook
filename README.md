...
#### pythonD实战篇
 ...
 - [01 - 新手必会，pycharm的调试功能(史上最详篇)](./pythonD实战篇/01%20-%20新手必会，pycharm的调试功能(史上最详篇).md)
 - [02 - 还在用网易云音乐客户端？out了~](./pythonD实战篇/02%20-%20还在用网易云音乐客户端？out了~.md)
 - [03 - 你应该了解的python虚拟环境与依赖管理](./pythonD实战篇/03%20-%20你应该了解的python虚拟环境与依赖管理.md)
 - [04 - 用 Python 教你制作查找电脑上隐藏文件的小工具](./pythonD实战篇/04%20-%20用%20Python%20教你制作查找电脑上隐藏文件的小工具.md)
 - [05 - 用Python实现ppt转化图片(附带长图合并功能)](./pythonD实战篇/05%20-%20用Python实现ppt转化图片(附带长图合并功能).md)
 - [06 - exe文件？你也可以编写！](./pythonD实战篇/06%20-%20exe文件？你也可以编写！.md)
 - [07 - 2分钟教你实现文件自动归类（超级简单哟）](./pythonD实战篇/07%20-%202分钟教你实现文件自动归类（超级简单哟）.md)
 - [08 - Python操作 excel ？应该这么玩！](./pythonD实战篇/08%20-%20Python操作%20excel%20？应该这么玩！.md)
